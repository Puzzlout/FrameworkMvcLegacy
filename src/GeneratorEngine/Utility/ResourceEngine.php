...
class ResourceEngine extends \WebDevJL\Framework\GeneratorEngine\Core\ResourceConstantsClassEngine {
  ...
  private function GenerateCommonResxFiles($resources) {
    $this->NamespaceApplicationRootGeneratedFolder = "Applications\\" . \WebDevJL\Framework\FrameworkConstants::APP_NAME . "\Resources\\Common";
    $this->DestinationFolder = \WebDevJL\Framework\Enums\ApplicationFolderName::AppsFolderName . \WebDevJL\Framework\FrameworkConstants::APP_NAME . \WebDevJL\Framework\Enums\ApplicationFolderName::ResourceCommonFolderName;
  ...
  private function GenerateControllerResxFiles($resources) {
    $this->NamespaceApplicationRootGeneratedFolder = "Applications\\" . \WebDevJL\Framework\FrameworkConstants::APP_NAME . "\Resources\\Controller";
    $this->DestinationFolder = \WebDevJL\Framework\Enums\ApplicationFolderName::AppsFolderName . \WebDevJL\Framework\FrameworkConstants::APP_NAME . \WebDevJL\Framework\Enums\ApplicationFolderName::ResourceControllerFolderName;
