...
<html lang="<?php echo $this->app->locale; ?>">
  <head>
    ...
    <?php
    echo WebDevJL\Framework\UC\StylesheetControl::Init()->ForInternalResource("Applications/" . WebDevJL\Framework\Core\Config::Init($this->app)->Get(WebDevJL\Framework\Enums\AppSettingKeys::APP_NAME) . "/ClientSide/css/app/reset.css");
    echo WebDevJL\Framework\UC\StylesheetControl::Init()->ForInternalResource("Web/library/css/core/bootstrap.css");
    echo WebDevJL\Framework\UC\StylesheetControl::Init()->ForInternalResource("Applications/" . WebDevJL\Framework\Core\Config::Init($this->app)->Get(WebDevJL\Framework\Enums\AppSettingKeys::APP_NAME) . "/ClientSide/css/addons/toastr.css");
  ...
  <body id="home">
    ...
    echo WebDevJL\Framework\UC\ScriptControl::Init()->ForInternalResource("Applications/" . WebDevJL\Framework\Core\Config::Init($this->app)->Get(WebDevJL\Framework\Enums\AppSettingKeys::APP_NAME) . "/ClientSide/js/addons/toastr.js");
    echo WebDevJL\Framework\UC\ScriptControl::Init()->ForInternalResource("Web/library/js/services/config.js");
    echo WebDevJL\Framework\UC\ScriptControl::Init()->ForInternalResource("Web/library/js/services/dataservice.js");
    echo WebDevJL\Framework\UC\ScriptControl::Init()->ForInternalResource("Web/library/js/services/utils.js");
    ?>
